...
// GetChrRef reads a refGene file and returns a map of chromosomes to slices of intervals denoting genes
// func GetChrGene(fileName string) ChrInterval {
